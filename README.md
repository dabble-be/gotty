...
[release]: https://fork.dabble.be/gotty/releases
[wercker]: https://app.wercker.com/project/bykey/03b91f441bebeda34f80e09a9f14126f
[license]: https://fork.dabble.be/gotty/blob/master/LICENSE
...
Download the latest stable binary file from the [Releases](https://fork.dabble.be/gotty/releases) page. Note that the release marked `Pre-release` is built for testing purpose, which can include unstable or breaking changes. Download a release marked [Latest release](https://fork.dabble.be/gotty/releases/latest) for a stabale build.
...
See the [`.gotty`](https://fork.dabble.be/gotty/blob/master/.gotty) file in this repository for the list of configuration options.
